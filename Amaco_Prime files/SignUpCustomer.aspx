<%@ Page Title="" Language="C#" MasterPageFile="~/AMACO.Master" AutoEventWireup="true" CodeBehind="SignUpCustomer.aspx.cs" Inherits="P_AMACO.SignUpCustomer" %>
    ...
    <!-- -->
        <div style="text-align:center;margin:60px 0;">
            ...
            <div style="margin:50px 30%;background:rgba(255, 0, 0, 0.1);padding: 40px 30px;border-radius:30px; ">
                ...
                <h1 style="font-family: 'Ubuntu Mono', monospace;margin-bottom:40px;">Customer SignUP</h1> 
                ...
                <div class="form-floating" style="margin-bottom:10px;">
                    ...
                    <label for="TextBox5">Home Address</label>
                ...
                <div>
                    <asp:LinkButton ID="LinkButton2" class="w-50 btn btn-info" runat="server" style="border:1px solid black; color:black;" OnClick="LinkButton2_Click1" ><i class="fas fa-plus-circle"></i> Create Account</asp:LinkButton>
                </div>
